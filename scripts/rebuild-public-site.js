...
<head>
  ...
  <link rel="stylesheet" href="${prefix}css/studio-system.css?v=20260828-1">
...
<script src="${prefix}js/studio-system.js?v=20260828-1" defer></script>
...
<section class="section"><div class="section-inner">
  ...
  <div class="service-index">
    <article class="service-row reveal"><span>01</span><h3>Strategie & Struktur</h3><div><p>Wir ordnen Angebote, Zielgruppen und Inhalte, bevor das erste Layout entsteht.</p><ul><li>Positionierung</li><li>Informationsarchitektur</li><li>Nutzerwege</li><li>Content-Plan</li></ul></div></article>
    <article class="service-row reveal"><span>02</span><h3>Gestaltung & Sprache</h3><div><p>Eine visuelle und sprachliche Richtung, die Wiedererkennung schafft und sich konsequent durchzieht.</p><ul><li>Art Direction</li><li>UI-Design</li><li>Responsive Design</li><li>Webtexte</li></ul></div></article>
    <article class="service-row reveal"><span>03</span><h3>Entwicklung & Betrieb</h3><div><p>Schnelle, zugängliche und wartbare Umsetzung – passend zum Inhalt und zum Team dahinter.</p><ul><li>Frontend</li><li>CMS</li><li>Formulare</li><li>Technisches SEO</li></ul></div></article>
  </div>
</div></section>
...
<section class="section dark"><div class="section-inner"><div class="process-line"><article class="process-step reveal"><small>01 · Verstehen</small><h3>Ausgangslage klären</h3><p>Unternehmen, Zielgruppen, bestehende Inhalte und technische Rahmenbedingungen.</p></article><article class="process-step reveal"><small>02 · Verdichten</small><h3>Richtung festlegen</h3><p>Kernaussage, Struktur und visuelle Haltung werden gemeinsam entschieden.</p></article><article class="process-step reveal"><small>03 · Bauen</small><h3>Konsequent umsetzen</h3><p>Design und Entwicklung entstehen eng miteinander, auf allen Bildschirmgrößen.</p></article><article class="process-step reveal"><small>04 · Schärfen</small><h3>Prüfen & starten</h3><p>Inhalte, Bedienung, Technik und Auffindbarkeit werden vor dem Start kontrolliert.</p></article></div></div></section>
...
<section class="section"><div class="section-inner"><div class="section-head reveal"><div><p class="section-label">Erst der Prozess, dann das Werkzeug</p><h2>Automatisierung beginnt nicht mit KI.</h2></div><p>Sie beginnt mit einer nüchternen Frage: Welche Arbeit wiederholt sich, folgt klaren Regeln und lässt sich zuverlässig prüfen?</p></div><div class="service-index"><article class="service-row reveal"><span>01</span><h3>Eingänge strukturieren</h3><div><p>E-Mails, Formulare und Dokumente erfassen, zuordnen und für die Bearbeitung vorbereiten.</p><ul><li>Klassifizierung</li><li>Extraktion</li><li>Validierung</li></ul></div></article><article class="service-row reveal"><span>02</span><h3>Systeme verbinden</h3><div><p>Informationen zwischen bestehenden Werkzeugen übertragen und doppelte Pflege reduzieren.</p><ul><li>APIs</li><li>CRM / ERP</li><li>Benachrichtigungen</li></ul></div></article><article class="service-row reveal"><span>03</span><h3>Entscheidungen vorbereiten</h3><div><p>KI fasst zusammen oder schlägt vor. Kritische Freigaben bleiben nachvollziehbar beim Menschen.</p><ul><li>Quellen</li><li>Freigaben</li><li>Protokolle</li></ul></div></article></div></div></section>
<section class="section dark"><div class="section-inner"><div class="section-head reveal"><div><p class="section-label">Ein kontrollierter Ablauf</p><h2>Automatisch heißt nicht unkontrolliert.</h2></div><p>Jeder Schritt braucht Eingaben, Regeln, Fehlerwege und eine klare Verantwortung. Genau das machen wir sichtbar.</p></div>${interfaceVisual('Vorgang 0247')}</div></section>
<section class="section dark"><div class="section-inner"><div class="process-line"><article class="process-step reveal"><small>01 · Eingang</small><h3>Information kommt an</h3><p>Quelle, Format und Berechtigungen werden eindeutig erfasst.</p></article><article class="process-step reveal"><small>02 · Prüfung</small><h3>Regeln greifen</h3><p>Pflichtfelder, Plausibilität und mögliche Risiken werden kontrolliert.</p></article><article class="process-step reveal"><small>03 · Verarbeitung</small><h3>Systeme arbeiten</h3><p>Daten werden übertragen, ergänzt oder für eine Entscheidung vorbereitet.</p></article><article class="process-step reveal"><small>04 · Freigabe</small><h3>Menschen behalten Kontrolle</h3><p>Kritische Fälle landen mit Kontext und Verlauf bei der richtigen Person.</p></article></div></div></section>
...
<section class="section dark"><div class="section-inner"><div class="section-head reveal"><div><p class="section-label">Vom Gespräch zum Transfer</p><h2>Der Workshop beginnt vor dem Workshop.</h2></div><p>Vorab klären wir Rollen, Werkzeuge und typische Aufgaben. So passt der Termin zu Ihrem Unternehmen und endet mit konkreten nächsten Schritten.</p></div><div class="process-line"><article class="process-step reveal"><small>01 · Vorgespräch</small><h3>Situation erfassen</h3><p>Teilnehmer, heutige Nutzung und wiederkehrende Aufgaben.</p></article><article class="process-step reveal"><small>02 · Vorbereitung</small><h3>Beispiele auswählen</h3><p>Übungen und Materialien werden auf die Gruppe zugeschnitten.</p></article><article class="process-step reveal"><small>03 · Workshop</small><h3>Gemeinsam arbeiten</h3><p>Verstehen, ausprobieren, prüfen und offen diskutieren.</p></article><article class="process-step reveal"><small>04 · Transfer</small><h3>Nächste Schritte</h3><p>Geeignete Anwendungsfälle und verbindliche Regeln festhalten.</p></article></div></div></section>
...
<section class="section"><div class="section-inner"><div class="portrait-stage"><figure class="portrait-frame reveal"><img src="assets/patrick-vach.webp" alt="Patrick Vach, Inhaber von vachsystems" width="1024" height="1280" loading="lazy"></figure><div class="portrait-copy reveal"><p class="section-label">Inhaber & Projektleitung</p><h2>Patrick Vach</h2><p>Sie sprechen mit der Person, die Ihr Projekt versteht, strukturiert und begleitet. Dadurch bleiben Entscheidungen schnell, Zusammenhänge erhalten und Verantwortung klar.</p><div class="signature"><span>Konzeption</span><span>Art Direction</span><span>Entwicklung</span><span>Projektleitung</span></div></div></div></div></section>
<section class="section dark"><div class="section-inner"><div class="section-head reveal"><div><p class="section-label">Arbeitsweise</p><h2>Klein genug für kurze Wege. Sorgfältig genug für große Ansprüche.</h2></div><p>Für Spezialthemen kommen gezielt passende Partner hinzu. Die inhaltliche und gestalterische Linie bleibt dennoch in einer Hand.</p></div><div class="process-line"><article class="process-step reveal"><small>01 · Zuhören</small><h3>Das echte Problem verstehen.</h3><p>Keine fertige Lösung verkaufen, bevor Ziel und Kontext klar sind.</p></article><article class="process-step reveal"><small>02 · Entscheiden</small><h3>Eine klare Richtung setzen.</h3><p>Alternativen offen bewerten und Entscheidungen nachvollziehbar machen.</p></article><article class="process-step reveal"><small>03 · Umsetzen</small><h3>Details konsequent lösen.</h3><p>Inhalt, Gestaltung und Technik nicht in getrennten Silos behandeln.</p></article><article class="process-step reveal"><small>04 · Verantwortung</small><h3>Auch Nein sagen.</h3><p>Wenn eine kleinere Lösung reicht oder wir nicht passen, sagen wir das offen.</p></article></div></div></section>
...
<section class="section dark"><div class="section-inner"><div class="section-head reveal"><div><p class="section-label">Danach</p><h2>Kein Verkaufstheater. Ein klares Gespräch.</h2></div><p>Wir klären offene Fragen, ordnen das Vorhaben ein und sagen Ihnen, ob und wie eine Zusammenarbeit sinnvoll ist.</p></div><div class="process-line"><article class="process-step reveal"><small>01</small><h3>Anfrage prüfen</h3><p>Wir lesen, was heute besteht und was sich verändern soll.</p></article><article class="process-step reveal"><small>02</small><h3>Rückfragen klären</h3><p>Falls nötig, sprechen wir kurz über Ziel, Umfang und Rahmen.</p></article><article class="process-step reveal"><small>03</small><h3>Vorgehen skizzieren</h3><p>Sie erhalten eine verständliche Einschätzung der sinnvollen nächsten Schritte.</p></article><article class="process-step reveal"><small>04</small><h3>Entscheidung treffen</h3><p>Erst wenn Richtung und Leistung klar sind, entsteht ein konkretes Angebot.</p></article></div></div></section>`);
...
home = home
  ...
  .replace('© 2026 vachsystems · Berlin', '© 2026 vachsystems · Berlin · ohne Tracking');
